    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            SizedBox(height: 20),
            Text(
              '地址：TQjVwofuGBGc21SFF2sywf8bkXtYpY8znt',
              style: TextStyle(fontSize: 16),
            ),
            SizedBox(height: 20),
            Text(
              '訂單將保留 30 分鐘，請於時限內付款，票券將會寄到您提供的 Email - ' + email + ' !',
              style: TextStyle(fontSize: 16),
            ),
            SizedBox(height: 20),
            Text(
        ...
        body: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Padding(
              ...
              child: Text(
                '票券將會於您付款後約 1 小時內寄到您的 Email ，若逾時仍未收到票券，可點擊右上角聯繫 live chat，將由專人為您服務。',
                style: TextStyle(
                  fontSize: 20,
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            SizedBox(height: 20),
            Text(
              '總金額：${widget.currency} ${(amount).toStringAsFixed(2)}',
              style: TextStyle(
                fontSize: 24,
                color: Colors.red,
              ),
            ...
            SizedBox(height: 20),
            Text(
              '訂單將保留 2 小时，請於時限內付款，票券將會寄到您提供的 Email - ' + email + ' !',
              style: TextStyle(fontSize: 16),
            ),
            SizedBox(height: 20),
            Text(
